...
<div class='btn btn-success' style='width:100%;direction: rtl;text-align:right'> تقرير عن الصادرات   </div>              
...
<td>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_done_export.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
