...
<td>
     ...
     <option value="dname"> الشهر </option>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_done_salary.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
