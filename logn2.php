...
<meta name="viewport" content="width=device-width,initial-scale=1.5">
    ...
    function getinfo() {
      ...
      x.onreadystatechange=function() {
          if(x.readystate == 1){
              document.getElementById("state").innerHTML="جاري الاتصال بالسيرفر";
          } 
          
          else if(x.readystate == 2){
          document.getElementById("state").innerHTML="جاري تحقق من المعلومات";
              } 
          else if(x.readystate == 3){ 
          document.getElementById("state").innerHTML="جاري تحضير الطلب";
          }
 ...
 <div class="login_info">
	...
	<fieldset>
       ...
       <input  class="bt" type="reset" value="الغاء">
        ...
        <div id="state" style="text-align:center;font-size:18px; color:red"> </div>
