...
<div class='btn btn-success' style='width:100%;direction: rtl;text-align:right'> تقرير عن المبيعات   </div>              
...
<td>
     ...
     <option value="optype">التصنيف </option>
 ...
 <td> <a href="#" onclick = 'return false;' onmousedown='reports("report_done_sel.php");'class="btn btn-primary btn-user btn-block"> بحث</a></td>
 ...
 <td width='20%'>مبيعات بين فترتين :</td>
