<?php include "connect.php";
 ...
 $name = $_POST['search_text'];
    if($name){  
        ...
        $q = mysql_query("select * from `store_exp` where
         (`rname` like '%$name%' or cno like '%$name%' or
          dname like '%$name%' or pname like '%$name%' or ptype like '%$name%') and arrive=0  ")or die(mysql_error());
